...
<body>
    <form class="add_customer_form" action="customer_profile_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                <label>Balance (PKR) : <label id="info_label"><?php echo number_format($balance) ?></label></label>
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                <label>Bank Branch :
                    <label id="info_label">
                        <?php
                            if ($branch == "lahore") {echo "Lahore";}
                            elseif ($branch == "karachi") {echo "Karachi";}
                            elseif ($branch == "islamabad") {echo "Islamabad";}
                            elseif ($branch == "bhawalpur") {echo "Bhawalpur";}
                            elseif ($branch == "multan") {echo "Multan";}
                        ?>
                    </label>
                </label>
            </div>
