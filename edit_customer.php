...
<body>
    <form class="add_customer_form" action="./edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="lahore" <?php if ($branch == 'kathmandu') {?> selected="selected" <?php }?>>lahore</option>
                    <option value="karachi" <?php if ($branch == 'delhi') {?> selected="selected" <?php }?>>karachi</option>
                    <option value="islamabad" <?php if ($branch == 'newyork') {?> selected="selected" <?php }?>>islamabad</option>
                    <option value="peshawar" <?php if ($branch == 'paris') {?> selected="selected" <?php }?>>peshawar</option>
                    <option value="bhawalpur" <?php if ($branch == 'riyadh') {?> selected="selected" <?php }?>>bhawalpur</option>
                    <option value="multan" <?php if ($branch == 'moscow') {?> selected="selected" <?php }?>>multan</option>
                </select>
            </div>
        </div>
